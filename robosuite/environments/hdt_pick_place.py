...
from robosuite.environments.hdt import HDTEnv
...
from robosuite.models.robots import HDT
from robosuite.models.tasks import PickPlaceTask, UniformRandomSampler


class HDTPickPlace(HDTEnv):
    def __init__(
            self,
            gripper_type="HDTGripper",
...
class HDTPickPlaceSingle(HDTPickPlace):
    """
...
class HDTPickPlaceMilk(HDTPickPlace):
    """
...
class HDTPickPlaceBread(HDTPickPlace):
    """
...
class HDTPickPlaceCereal(HDTPickPlace):
    """
...
class HDTPickPlaceCan(HDTPickPlace):
    """
